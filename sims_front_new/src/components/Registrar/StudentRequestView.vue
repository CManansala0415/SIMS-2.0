    ...
    <div>
        ...
        <div class="table-responsive border p-3 small-font">
            <table class="table table-hover">
                ...
                <tbody>
                    <tr v-if="!preLoading && Object.keys(requestedItems).length" v-for="(app, index) in requestedItems">
                        <td class="align-middle">
                            <p class="">{{ req.acr_id }}</p>
                        </td>
                        <td class="align-middle">
                            <p class="">{{ req.acr_personname }}</p>
                        </td>
                        <td class="align-middle">
                            <p class="">{{ req.acr_itemrequested }}</p>
                        </td>
                        <td class="align-middle">
                            <p class="">{{ req.acr_dateadded }}</p>
                        </td>
                        <td class="align-middle">
                            <p :class="req.paystat_color">{{ req.acr_paystatusdesc }}</p>
                        </td>
                        <td class="align-middle">
