    ...
    <div class="modal fade" id="editdatamodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog modal-fullscreen modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body neu-bg" v-if="showSubjects">
                    ...
                    <div class="neu-card table-responsive border p-3 small-font neu-card">
                        <table class="neu-table-flat">
                            <!-- [index] = index nung group, [0] = yung first item na nasa group -->
                                <thead>
                                    <tr>
                                        <th style="color:#555555">No.</th>
                                        <th style="color:#555555">Subject Code</th>
                                        <th style="color:#555555">Subject Name</th>
                                        <th style="color:#555555">Units</th>
                                        <th style="color:#555555" class="text-center">Total Units</th>
                                        <th style="color:#555555" class="text-center" colspan="3">Schedule</th>
                                    </tr>
                                </thead>
                                <tbody>
