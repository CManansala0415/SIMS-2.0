...
<template>
  <form @submit.prevent="handleAccess" class="d-flex flex-column align-items-start small-font neu-card p-3">
    <div class="mb-3 w-100">
      <!-- OUTER ACCORDION -->
      <div class="accordion accordion-flush" id="moduleAccordion">
        <div class="accordion-item" v-for="(mod, modindex) in accessModuleData" :key="modindex">
          <h2 class="accordion-header" :id="'module-heading-' + modindex">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
              :data-bs-target="'#module-collapse-' + modindex" aria-expanded="false"
              :aria-controls="'module-collapse-' + modindex">
              {{ mod.module_description }}
            </button>
          </h2>

          <div :id="'module-collapse-' + modindex" class="accordion-collapse collapse"
            :aria-labelledby="'module-heading-' + modindex" data-bs-parent="#moduleAccordion">
            <div class="accordion-body">
              <ul class="list-group">
                <li class="list-group-item">
                  <div class="p-3">
                    <div class="form-check form-switch">
                      <input class="form-check-input" type="checkbox" @change="mode(modindex)"
                        :checked="mod.module_grant" :value="mod.module_grant" />
                      <label class="form-check-label">Grant Module Access</label>
                    </div>
                  </div>
                </li>

                <li class="list-group-item" v-for="(acc, accindex) in mod.module_access" :key="accindex">
                  <div class="border p-3">
                    <div class="form-check form-switch">
                      <input class="form-check-input" type="checkbox" :checked="acc.access_checked"
                        @change="modify(modindex, accindex, acc.access_checked)" :disabled="acc.access_disabled"
                  ...
                  <!-- INNER ACCORDION -->
                  <div class="border">
                    <div class="accordion accordion-flush" :id="'actionAccordion-' + modindex + '-' + accindex">
                      <div class="accordion-item">
                        <h2 class="accordion-header" :id="'action-heading-' + modindex + '-' + accindex">
                          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            :data-bs-target="'#action-collapse-' + modindex + '-' + accindex" aria-expanded="false"
                        ...
                        <div :id="'action-collapse-' + modindex + '-' + accindex" class="accordion-collapse collapse"
                          ...
                          <div class="p-3">
                            <div class="form-check form-switch">
                              <input class="form-check-input" type="checkbox"
                                ...
                                :checked="acc.access_viewing" disabled="true" :value="acc.access_viewing" />
                          ...
                          <div class="p-3">
                            <div class="form-check form-switch">
                              <input class="form-check-input" type="checkbox"
                                ...
                                :checked="acc.access_modifying" :disabled="!acc.access_checked"
    ...
    <button type="submit" :disabled="saving ? true : false" class="neu-btn neu-green p-2"><font-awesome-icon icon="fa-solid fa-gear"/>
      Save
    </button>
  </form>
</template>
