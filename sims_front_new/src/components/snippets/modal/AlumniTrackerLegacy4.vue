            ...
            <div v-if="Object.keys(milestoneCompHeader).length">
                ...
                <div id="printform" class="h-auto d-flex flex-column justify-content-center align-items-start">
                    ...
                    <div class="small-font bg-opaque "
                        style="width: 795px;  height:1215px; border:2px solid black; font-size: 8.8px;">
                        <!-- height:1315px; width: 745px; -->
                        <div class="h-100 backdrop d-flex flex-column justify-content-between">
                                    ...
                                    <div class="container w-100 border shadow-sm border" v-if="milestoneCompHeader[0] !== undefined"> <!--v-for="(mtc, index) in milestoneCompHeader"-->
                                        <div class="row bg-body-subtle">
                                            <div class="col-12 d-flex flex justify-content-center green-mid text-white">
                                                ...
                                                milestoneCompHeader[0].arc_semester }})
                                            </div>
                                        </div>
                                        <div class="col-12 p-0">
                                            <table class="backdrop border-secondary-subtle w-100">
                                                ...
                                                <tbody>
                                                    <tr
                                                        v-if="!Object.keys(milestoneCompData).length && !milestoneCompLoading">
                                                    ...
                                                    <tr v-if="Object.keys(milestoneCompData).length && !milestoneCompLoading"
                                                        v-for="(c, index) in milestoneCompData[milestoneCompHeader[0].arc_id]">
                                                        <td class="align-middle">
                                                            <div
                                                                style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
                                    ...
                                    <div class="container w-100 border shadow-sm border" v-if="milestoneCompHeader[1] !== undefined"> <!--v-for="(mtc, index) in milestoneCompHeader"-->
                                        <div class="row bg-body-subtle">
                                            <div class="col-12 d-flex flex justify-content-center green-mid text-white">
                                                ...
                                                <span class="fw-bold">&nbsp;</span>({{
                                                milestoneCompHeader[1].arc_semester }})
                                            </div>
                                        </div>
                                        <div class="col-12 p-0">
                                            <table class="backdrop border-secondary-subtle w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr v-if="Object.keys(milestoneCompData).length && !milestoneCompLoading"
                                                        v-for="(c, index) in milestoneCompData[milestoneCompHeader[1].arc_id]">
                                                        <td class="align-middle">
                                                            <div
                                                                style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
                                                                <span class="fw-bold">{{ c.arc_subjectcode }}</span>
                                    ...
                                    <div class="container w-100 border shadow-sm border" v-if="milestoneCompHeader[2] !== undefined"> <!--v-for="(mtc, index) in milestoneCompHeader"-->
                                        <div class="row bg-body-subtle">
                                            <div class="col-12 d-flex flex justify-content-center green-mid text-white">
                                                ...
                                                <span class="fw-bold">&nbsp;</span>({{
                                                milestoneCompHeader[2].arc_semester }})
                                            </div>
                                        </div>
                                        <div class="col-12 p-0">
                                            <table class="backdrop border-secondary-subtle w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr v-if="Object.keys(milestoneCompData).length && !milestoneCompLoading"
                                                        v-for="(c, index) in milestoneCompData[milestoneCompHeader[2].arc_id]">
                                                        <td class="align-middle">
                                                            <div
                                                                style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
                                                                <span class="fw-bold">{{ c.arc_subjectcode }}</span>
                                    ...
                                    <div class="container w-100 border shadow-sm border" v-if="milestoneCompHeader[3] !== undefined"> <!--v-for="(mtc, index) in milestoneCompHeader"-->
                                        <div class="row bg-body-subtle">
                                            <div class="col-12 d-flex flex justify-content-center green-mid text-white">
                                                ...
                                                <span class="fw-bold">&nbsp;</span>({{
                                                milestoneCompHeader[3].arc_semester }})
                                            </div>
                                        </div>
                                        <div class="col-12 p-0">
                                            <table class="backdrop border-secondary-subtle w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr v-if="Object.keys(milestoneCompData).length && !milestoneCompLoading"
                                                        v-for="(c, index) in milestoneCompData[milestoneCompHeader[3].arc_id]">
                                                        <td class="align-middle">
                                                            <div
                                                                style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
                                                                <span class="fw-bold">{{ c.arc_subjectcode }}</span>
                            ...
                            <div class="container w-100 backdrop mt-3 p-0">
                                ...
                                <!-- <div class="w-100">
                                    <div class="border p-1 col-12">
                                        <div class="d-flex gap-1 justify-content-center align-content-end p-1 small-font"
                                            style="height: 100px;">
                                        ...
                                        <div class="d-flex gap-1 justify-content-center p-1 small-font mt-3">
                                            <div class="w-100">
                                                <div class="d-flex gap-1 justify-content-center p-2">
                                                    <div class="w-100">
                                                        <span class="fw-semibold fst-italic">Not valid without school
                                                            seal. Any
                                                            erasure or alteration renders the whole Transcript of
                                                            Records
                                    ...
                                    <div class="container w-100 border shadow-sm border" v-if="milestoneCompHeader[4] !== undefined"> <!--v-for="(mtc, index) in milestoneCompHeader"-->
                                        <div class="row bg-body-subtle">
                                            <div class="col-12 d-flex flex justify-content-center green-mid text-white">
                                                ...
                                                <span class="fw-bold">&nbsp;</span>({{
                                                milestoneCompHeader[4].arc_semester }})
                                            </div>
                                        </div>
                                        <div class="col-12 p-0">
                                            <table class="backdrop border-secondary-subtle w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr v-if="Object.keys(milestoneCompData).length && !milestoneCompLoading"
                                                        v-for="(c, index) in milestoneCompData[milestoneCompHeader[4].arc_id]">
                                                        <td class="align-middle">
                                                            <div
                                                                style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
                                                                <span class="fw-bold">{{ c.arc_subjectcode }}</span>
                                    ...
                                    <div class="container w-100 border shadow-sm border" v-if="milestoneCompHeader[5] !== undefined"> <!--v-for="(mtc, index) in milestoneCompHeader"-->
                                        <div class="row bg-body-subtle">
                                            <div class="col-12 d-flex flex justify-content-center green-mid text-white">
                                                ...
                                                <span class="fw-bold">&nbsp;</span>({{
                                                milestoneCompHeader[5].arc_semester }})
                                            </div>
                                        </div>
                                        <div class="col-12 p-0">
                                            <table class="backdrop border-secondary-subtle w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr v-if="Object.keys(milestoneCompData).length && !milestoneCompLoading"
                                                        v-for="(c, index) in milestoneCompData[milestoneCompHeader[5].arc_id]">
                                                        <td class="align-middle">
                                                            <div
                                                                style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
                                                                <span class="fw-bold">{{ c.arc_subjectcode }}</span>
                                    ...
                                    <div class="container w-100 border shadow-sm border" v-if="milestoneCompHeader[6] !== undefined"> <!--v-for="(mtc, index) in milestoneCompHeader"-->
                                        <div class="row bg-body-subtle">
                                            <div class="col-12 d-flex flex justify-content-center green-mid text-white">
                                                ...
                                                <span class="fw-bold">&nbsp;</span>({{
                                                milestoneCompHeader[6].arc_semester }})
                                            </div>
                                        </div>
                                        <div class="col-12 p-0">
                                            <table class="backdrop border-secondary-subtle w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr v-if="Object.keys(milestoneCompData).length && !milestoneCompLoading"
                                                        v-for="(c, index) in milestoneCompData[milestoneCompHeader[6].arc_id]">
                                                        <td class="align-middle">
                                                            <div
                                                                style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
                                                                <span class="fw-bold">{{ c.arc_subjectcode }}</span>
                                    ...
                                    <div class="container w-100 border shadow-sm border" v-if="milestoneCompHeader[7] !== undefined"> <!--v-for="(mtc, index) in milestoneCompHeader"-->
                                        <div class="row bg-body-subtle">
                                            <div class="col-12 d-flex flex justify-content-center green-mid text-white">
                                                ...
                                                <span class="fw-bold">&nbsp;</span>({{
                                                milestoneCompHeader[7].arc_semester }})
                                            </div>
                                        </div>
                                        <div class="col-12 p-0">
                                            <table class="backdrop border-secondary-subtle w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr v-if="Object.keys(milestoneCompData).length && !milestoneCompLoading"
                                                        v-for="(c, index) in milestoneCompData[milestoneCompHeader[7].arc_id]">
                                                        <td class="align-middle">
                                                            <div
                                                                style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
                                                                <span class="fw-bold">{{ c.arc_subjectcode }}</span>
