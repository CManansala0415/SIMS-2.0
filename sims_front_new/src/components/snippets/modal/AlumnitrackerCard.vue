    ...
    <div class="d-flex flex-wrap w-100">
        ...
        <div v-else class="small-font">
            <div v-if="Object.keys(milestoneCompHeader).length" class="d-flex flex-column">
                <div class="col-12">
                    <div class="p-3">
                        <span class="fw-bold border bg-primary text-white p-2 rounded-3">Card</span>
                    </div>
                </div>
                <div class="col-12 small-font d-flex flex-column" id="printform" style="font-size: 10px;">
                    <div v-for="(mtc, index) in milestoneCompHeader">
                        <div style="padding: 5px;">
                            <div class="d-flex mb-3">
                                <div class="w-50 d-flex justify-content-center align-content-center">
                                ...
                                <div class="d-flex flex-column justify-content-center text-center w-100">
                                    <p class="m-0 fw-bold">CENTRAL LUZON COLLEGE OF SCIENCE AND TECHNOLOGY, INC.
                                        CELTECH COLLEGE</p>
                                ...
                                <div class="w-50 d-flex justify-content-center align-content-center"><img src="/img/clcst_logo.png" height="100px" width="100px"
                                        alt="..."></div>
                            </div>
                            <div
                                class="p-3 border shadow d-flex flex-column card justify-content-center align-items-center">
                                <div class="row w-100">
                                ...
                                <table class="w-100 table">
                                    <thead>
                                        <tr>
                                            <th class="border border-black p-2 bg-black text-white">
                                ...
                                <!-- <div class="card">
                                    <span>Note: This is official card</span>
                                </div> -->
                            </div>
                        </div>
