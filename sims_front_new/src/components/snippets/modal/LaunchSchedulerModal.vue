...
import NeuLoader5 from '../loaders/NeuLoader5.vue';
  ...
  <div v-else class="container-fluid">
    <div v-if="!removeSubject" class="row">
      ...
      <div class="col-md-4 overflow-auto small-font" style="height: 40rem;">
        <!-- OTHER ALTERNATIVES -->
        <div class="card bg-transparent border-0 mb-3  neu-card">
          ...
          <div class="card-body">
            <div class="row g-2">
              <div class="col-6">
                <!-- <div
                  class="tile-option neu-card-inner"
              ...
              <div class="col-6">
                <div class="tile-option neu-card-inner" :class="{ active: mergeClass == 1 }" @click="setOthers(91)">
        ...
        <div class="card bg-transparent border-0 mb-3  neu-card">
          ...
          <div class="card-body">
            <div class="row g-2">
              <div v-for="bl in building" :key="bl.buil_id" class="col-6">
                <div class="tile-option neu-card-inner" :class="{ active: buildingId === bl.buil_id }"
        ...
        <div class="card bg-transparent border-0 mb-3  neu-card">
          ...
          <div class="card-body">
            <div v-if="Object.keys(filteredClassroom).length" class="row g-2">
              <div v-for="cl in filteredClassroom" :key="cl.classr_id" class="col-6">
                <div class="tile-option neu-card-inner" :class="{ active: classroomId === cl.classr_id }"
      ...
      <div class="col-md-8 overflow-auto neu-card d-flex justify-content-center align-items-center">
        ...
        <!-- OCCUPIED ROOM -->
        <div v-if="(buildingId && classroomId) && !loading && occupied" class="p-3 w-100">
          <div class="card border-0 bg-transparent neu-card bg-opacity-25">
            ...
            <div class="card-body">
              ...
              <button v-if="(buildingId && classroomId && occupier.can_merge == 1)" @click="mergeClassTo(occupier)"
                class="neu-btn neu-blue">
                <i class="bi bi-people-fill me-1"></i> Merge Class Here
              </button>

              <div v-else class="alert alert-info py-4 small mb-0 neu-card-inner border-0">
                <p class="mb-1">
        ...
        <!-- AVAILABLE ROOM -->
        <div v-if="(buildingId && classroomId) && !loading && !occupied" class="border p-2 rounded w-100">
          <input v-if="!forMerge" v-model="searchValue" @keyup="filterSubject()" class="neu-input mb-2"
            placeholder="🔍 Search subjects..." />

          <div class="card border-0 neu-card-inner bg-transparent">
            <div class="table-responsive small-font  p-3" v-if="!loading">
          ...
          <div class="mt-3 d-flex gap-2">
            <button :disabled="!activeID || !buildingId || !classroomId"
              @click="assign(activeID, activeName, buildingId, classroomId, false)" class="neu-btn neu-green p-2">
              ✅ Assign Subject
            </button>
    ...
    <div v-else class="p-4 rounded border neu-card text-center">
      ...
      <div v-else>
        <div v-if="!hasMergedClass">
          ...
          <button @click="assign('', '', '', '', true)" class="neu-btn neu-red w-50">
...
.tile-option.active {
  background: rgba(50, 228, 145, 0.6);
  color: #fff;
  /* border-color: #03ffdd; */
  border: none;
  box-shadow:
    2px 2px 10px rgba(87, 247, 172, 0.6),
    -2px -2px 10px rgba(87, 247, 172, 0.6);
}
