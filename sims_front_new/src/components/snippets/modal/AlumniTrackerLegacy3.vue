    ...
    <div class="w-100">
        ...
        <div v-else class="w-100 p-3  d-flex flex-column justify-content-center align-items-center">
            <div v-if="Object.keys(milestoneCompHeader).length">
                <div class="mb-3">
                    <div class="p-3">
                        <span class="fw-bold bg-primary text-white p-2 rounded-3">Transcript of
                            Records</span>
                    </div>
                </div>
                <div class="small-font bg-opaque " id="printform"
                    style="width: 795px;  border:2px solid black; font-size: 8px;"> <!-- height:1226px; width: 745px; -->
                    <div class="h-100 backdrop d-flex flex-column justify-content-around">
                        <div class="container w-100">
                            <div class="row">
                                <div class="p-2 col-3 d-flex justify-content-center align-content-center ">
                                ...
                                <div class="p-2 col-9">
                                    <div class="text-end p-2">
                                        ...
                                        <p class="m-0 fw-normal small-font">B. Mendoza St., Brgy. Sto. Rosario, City of
                                            San
                                            Fernando,
                                ...
                                <div class="p-1 col-9 d-flex justify-content-center align-content-center">
                                    <div
                                        class="text-start d-flex flex-column justify-content-center align-content-center w-100">
                                        <p class="m-0 p-0">
                                ...
                                <div
                                    class="p-2 col-3 d-flex flex-column justify-content-center align-content-center">
                        ...
                        <div class="container w-100 backdrop ">
                            ...
                            <div class="row bg-body-subtle" v-for="(mtc, index) in milestoneCompHeader">
                                        ...
                                        <tbody>
                                            ...
                                            <td class="align-middle">
                                                ...
                                                <td class="align-middle">
                                                    <div
                                                        style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
                                                        <span class="fw-bold">{{ c.arc_lecture + c.arc_laboratory
                                                            }}</span>
                                                    </div>
                                                </td>
                                                <!-- <td class="align-middle">
                                    ...
                                    <div class="d-flex gap-1 justify-content-center p-1 small-font mt-3">
                                        <div class="w-100">
                                            <div class="d-flex gap-1 justify-content-center p-2">
                                                <div class="w-100">
                                                    <span class="fw-semibold fst-italic">Not valid without school seal. Any
                                                        erasure or alteration renders the whole Transcript of Records
