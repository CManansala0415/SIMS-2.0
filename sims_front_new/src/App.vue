...
import SkeletonHeaderLoader from './components/snippets/loaders/SkeletonHeaderLoader.vue';
const user = ref('')
const userID = ref('')
...
const bgGradient = ref(`
      ...
      background: linear-gradient(
        to top,
        rgba(229, 237, 245, 1),
        rgba(229, 237, 245, 0.5),
        rgba(229, 237, 245, 0)
      );
`)
</script>
<template>
  <div class="container border rounded-3 shadow flex-column neu-card p-0">
      <div :style="path!='/' ? bgStudents : ''">
      <div :style="path!='/' ? bgGradient : ''">
      </div>
