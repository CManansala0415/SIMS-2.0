...
// import BillingTuition from '../components/Accounting/BillingTuition.vue';
// import BillingRequest from '../components/Accounting/BillingRequest.vue';
...
// import FacultyClasses from '../components/Faculty/FacultyClasses.vue';
...
const routes = [
    ...
    // {
    //     path: '/accounting-billing', name:'/accounting-billing', component: BillingTuition
    // },
    {
        path: '/registrar-request', name:'/registrar-request', component: StudentRequestView
    },
    // {
    //     path: '/accounting-request', name:'/accounting-request', component: BillingRequest
    // },
    {
    ...
    // },
    // {
    //     path: '/faculty-classes', name:'/faculty-classes', component: FacultyClasses
    // },
    // {
