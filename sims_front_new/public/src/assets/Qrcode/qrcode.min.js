...
var qrcode = (function () {
    var t = function (t, r) {
        var e = t,
            ...
            s = function () {
                for (
                    var t = B.getPatternPosition(e), r = 0;
                    r < t.length;
                    r += 1
                )
            ...
            d = function (t, r) {
                for (
                    var e = (n << 3) | r, a = B.getBCHTypeInfo(e), u = 0;
                    u < 15;
                    u += 1
                ) {
                    var f = !t && 1 == ((a >> u) & 1);
            ...
            p = function (t, r, e) {
                for (
                    var n = A.getRSBlocks(t, r), o = b(), i = 0;
                    i < e.length;
                    i += 1
                ) {
                    var a = e[i];
                ...
                return (function (t, r) {
                    for (
                        ...
                        for (
                            a[u] = new Array(l.getLength() - 1), g = 0;
                            g < a[u].length;
                            g += 1
                        ) {
                    ...
                    for (g = 0; g < n; g += 1)
                        for (u = 0; u < r.length; u += 1)
                            g < i[u].length && ((d[w] = i[u][g]), (w += 1));
                    for (g = 0; g < o; g += 1)
                        for (u = 0; u < r.length; u += 1)
                            g < a[u].length && ((d[w] = a[u][g]), (w += 1));
                    return d;
                })(o, n);
            };
        (f.addData = function (t, r) {
            ...
            (f.make = function () {
                if (e < 1) {
                    for (var t = 1; t < 40; t++) {
                        for (
                            var r = A.getRSBlocks(t, n), o = b(), i = 0;
                            i < u.length;
                            i++
                        ) {
                            var a = u[i];
            ...
            (f.createSvgTag = function (t, r, e, n) {
                ...
                for (
                    ...
                    for (u = a * t + r, i = 0; i < f.getModuleCount(); i += 1)
                        f.isDark(a, i) &&
                            (l += "M" + (i * t + r) + "," + u + c);
                return (
                            ...
                            for (
                                ...
                                (i = "█"),
                                    u <= e &&
                                        ...
                                        u <= r &&
                                        r < c &&
                                        f.isDark(n, Math.floor((e - u) / 1)) &&
                                        (i = " "),
                                    u <= e &&
                                    e < c &&
                                    u <= r + 1 &&
                                    r + 1 < c &&
                                    f.isDark(o, Math.floor((e - u) / 1))
                                        ? (i += " ")
                                        : (i += "█"),
                                    (h += t < 1 && r + 1 >= c ? l[i] : g[i]);
                            h += "\n";
                ...
                multiply: function (t) {
                    for (
                        ...
                        for (var o = 0; o < t.getLength(); o += 1)
                            r[e + o] ^= C.gexp(
                                C.glog(n.getAt(e)) + C.glog(t.getAt(o))
                            );
                    return k(r, 0);
                },
                mod: function (t) {
                    ...
                    for (
                        var r = C.glog(n.getAt(0)) - C.glog(t.getAt(0)),
            ...
            var r = a,
                ...
                n = {
                    ...
                    write: function (t) {
                        ...
                        n < r.length &&
                            (r.length - n == 1
                                ? t.put(o(r.substring(n, n + 1)), 4)
                                : r.length - n == 2 &&
                                  t.put(o(r.substring(n, n + 2)), 7));
                    },
                },
                o = function (t) {
